...
// The InferenceFunc type is an adapter to allow the use of ordinary
// function as Inference mutator.
type InferenceFunc func(context.Context, *ent.InferenceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InferenceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.InferenceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InferenceMutation", m)
}
...
type SandboxFunc func(context.Context, *ent.SandboxMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SandboxFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SandboxMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SandboxMutation", m)
}
