...
func IsEnabled(v bool) predicate.Tenant {
	return predicate.Tenant(sql.FieldEQ(FieldIsEnabled, v))
}
...
func TagsIsNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldIsNull(FieldTags))
}

// TagsNotNil applies the NotNil predicate on the "tags" field.
func TagsNotNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldNotNull(FieldTags))
}

// IsEnabledEQ applies the EQ predicate on the "is_enabled" field.
func IsEnabledEQ(v bool) predicate.Tenant {
	return predicate.Tenant(sql.FieldEQ(FieldIsEnabled, v))
}

// IsEnabledNEQ applies the NEQ predicate on the "is_enabled" field.
func IsEnabledNEQ(v bool) predicate.Tenant {
	return predicate.Tenant(sql.FieldNEQ(FieldIsEnabled, v))
}

// IsEnabledIsNil applies the IsNil predicate on the "is_enabled" field.
func IsEnabledIsNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldIsNull(FieldIsEnabled))
}

// IsEnabledNotNil applies the NotNil predicate on the "is_enabled" field.
func IsEnabledNotNil() predicate.Tenant {
	return predicate.Tenant(sql.FieldNotNull(FieldIsEnabled))
}
