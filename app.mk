...
worker:
	-@go run $(GOFLAGS) -ldflags "$(LDFLAGS)" ./cmd/worker -c ./configs
...
wire:
	...
	@go run -mod=mod github.com/google/wire/cmd/wire ./cmd/worker
...
openapi:
	@cd ../../../api && \
	buf generate --template buf.server.openapi.gen.yaml
